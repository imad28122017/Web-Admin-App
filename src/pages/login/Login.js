...
import { 
Container, Alert, Button, FormGroup, Label, InputGroup, InputGroupAddon, Input, InputGroupText 
} from 'reactstrap';
    ...
    render() {
        ...
        return (
            <div className="auth-page">
                <Container>
                    <Widget className="widget-auth mx-auto" title={<h3 className="mt-0">Login to Smart Police System</h3>}>
                ...
                {new Date().getFullYear()} &copy; SMART POLICE SYSTEM - Admin Dashboard
